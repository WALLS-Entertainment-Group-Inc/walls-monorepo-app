...
namespace margelo::nitro::healthkit {
  ...
  public:
    ...
    std::optional<std::string> hardwareVersion     SWIFT_PRIVATE;
    ...
    std::optional<std::string> softwareVersion     SWIFT_PRIVATE;
    std::optional<std::string> udiDeviceIdentifier     SWIFT_PRIVATE;
